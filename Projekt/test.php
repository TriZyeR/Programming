...
// LoginIcon
if (!isset($_SESSION['loginIcon'])) {
  $_SESSION['loginIcon'] = 'Photos/LoggedOutIcon.png';
}
echo $_SESSION['loginIcon'];
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="menu_item">
      <img class="open-button" onclick="openForm()" id="imgLoginChange" src="<?php $_SESSION['loginIcon']; ?>">
    </div>
    <div class="outter">
      <div class="inner">
        <nav>
...
if (isset($_POST["submit_login"])) {
  if ($_POST["username_login"] == "" || $_POST["password_login"] == "") {
    ...
    if ($_POST["username_login"] == $row["username"] && $veryhashedpw == 1) {
      $_SESSION['loginIcon'] = "<script type='text/javascript'>
